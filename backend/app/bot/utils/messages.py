...
💬 <b>Диалог с ИИ-консультантом</b>

Задайте вопрос по вашему решению обычным сообщением. Например:
• «Можно собрать дешевле?»
• «Зачем в решении такой диск?»
• «Замени купольные камеры на буллеты»

Я отвечу с учётом вашей анкеты и каталога магазина.
"""

CONSULTANT_CHAT_THINKING = "💭 Думаю над ответом..."

CONSULTANT_CHAT_ENDED = """
✅ <b>Диалог завершён</b>

Возвращаю вас в главное меню. Решение и кнопки покупки остались выше в чате.
"""
