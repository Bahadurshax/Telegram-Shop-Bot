...
💬 <b>Давайте обсудим ваше решение</b>

Я на связи 🙂 Спрашивайте что угодно обычным сообщением — помогу разобраться:
• «А можно собрать подешевле?»
• «Зачем тут такой диск?»
• «Замени купольные на уличные буллеты»

Отвечаю с учётом вашей анкеты и того, что есть в наличии.
"""
